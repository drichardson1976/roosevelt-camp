...
export const RELEASE_NOTES = [
  { version: "13.214", date: "2026-04-10", time: "12:08 AM", author: "Derek Richardson", changes: ["Public: Hidden donation flow — double-click 'ROOSEVELT CAMP' title to donate to the RHS Girls Varsity Basketball program via Venmo", "Public: 3-step donation flow with name, email, amount, Venmo QR code, and automated thank-you email", "Public: 100% of donations go directly to the school basketball program"] },
  { version: "13.213", date: "2026-04-09", time: "11:17 PM", author: "Derek Richardson", changes: ["Admin: Added Projected Profits tab under Registrations — shows profit/loss based on paid vs registered sessions", "Admin: Profit chart shows sessions needed for break-even through $20K profit with paid/unpaid/needed visualization", "Admin: Includes cost breakdown (gym rental from permit #R282920, counselor pay), revenue status, unit economics, and daily breakdown table", "Admin: Unpaid gap highlighted so admin knows how much money to chase from registered-but-unpaid families"] },
  ...
  { version: "13.208", date: "2026-03-17", time: "8:10 PM", author: "Audrey Richardson", changes: ["Registration: Each day now shown on its own line in registration boxes (no more grouping same-session days together)", "Registration: Session Calendar child selection no longer resets when opening/closing registration modal or submitting registrations", "Registration: Moved calendar component outside main app to prevent React remounting on every render"] },
  { version: "13.207", date: "2026-03-17", time: "10:36 AM", author: "Audrey Richardson", changes: ["Registration: Sessions now limited to 30 campers max — each session shows spots remaining", "Registration: Sessions turn orange when 5 or fewer spots left, show 'FULL' when at capacity", "Registration: Parents cannot select or submit registrations for full sessions", "Registration: Submission blocked if registering multiple campers would exceed the limit", "Admin/Public: Fixed empty bullet dot showing for counselors with no position/year set"] },
  ...
  { version: "13.199", date: "2026-03-11", time: "8:28 PM", author: "Audrey Richardson", changes: ["Parent Payments: Credit card payments now live — embedded Stripe payment form appears directly on the site", "Parent Payments: Secure card form powered by Stripe — card details never touch our servers", "Parent Payments: Payment method selector updated — Venmo and Credit Card both fully functional, PayPal coming soon", "Parent Payments: Stripe webhook auto-confirms payments even if browser is closed"] },
  { version: "13.198", date: "2026-03-10", time: "9:51 PM", author: "Audrey Richardson", changes: ["Parent Payments: 'Pay Now' now opens a payment method selector — choose Venmo, Credit Card, or PayPal", "Parent Payments: Venmo option works as before — shows step-by-step instructions and reference code", "Parent Payments: Credit Card and PayPal options show 'Coming Soon' (will be enabled when accounts are set up)"] },
  ...
  { version: "13.188", date: "2026-03-02", time: "9:14 AM", author: "Audrey Richardson", changes: ["All: Changed camp location from Roosevelt High School to Magnuson Community Center (7110 62nd Ave NE, Seattle)", "Location: Updated address, parking info, and drop-off instructions for new venue", "Location: Added driving directions from I-5", "Public: Updated all location references throughout the website"] },
  { version: "13.187", date: "2026-02-28", time: "10:10 PM", author: "Audrey Richardson", changes: ["Counselor: Fixed camper names not showing — now supports both 'name' field and 'firstName/lastName' fields", "Counselor: Fixed counselor names in 'Other Counselors Working' section", "Counselor: Initials now calculated correctly from full name for campers without photos"] },
  { version: "13.186", date: "2026-02-28", time: "10:00 PM", author: "Audrey Richardson", changes: ["Login: Fixed Google sign-in requiring multiple page refreshes — now waits for account data to load instead of showing error", "Login: Google button shows 'Signing in...' spinner while waiting for background data", "Login: Seamless login flow even when clicking before data has loaded"] },
  { version: "13.185", date: "2026-02-28", time: "9:44 PM", author: "Audrey Richardson", changes: ["Counselor: Redesigned 'Scheduled to Work' tab — campers now shown directly below the calendar instead of only in a popup", "Counselor: My Campers section displays camper photos, names, grade, and age grouped by date and session", "Counselor: Calendar cards now show static session info (popup removed for cleaner UX)"] },
  { version: "13.184", date: "2026-02-28", time: "9:30 PM", author: "Derek Richardson", changes: ["All: Merged dev and main branches — combined multi-role login (main), counselor profile edit (dev), camp dates update (dev), and CSP/stale closure fixes (main)", "All: Version bump to 13.184 after merge conflict resolution"] },
  { version: "13.183", date: "2026-02-28", time: "9:15 PM", author: "Audrey Richardson", changes: ["Counselor: Fixed profile edit modal Save button stuck on 'Saving...' — added missing saveCounselors function with photo CDN upload support", "Counselor: Profile photos now upload to CDN storage before saving to database", "Counselor: Added error handling to profile save with user-friendly error messages"] },
  { version: "13.182", date: "2026-02-28", time: "9:11 PM", author: "Audrey Richardson", changes: ["Counselor: Added profile edit button in Next Steps section — click 'Add Photo' or 'Change Photo' to open profile edit modal", "Counselor: Profile edit modal allows counselors to update their bio and add/change their profile photo", "Counselor: Fixed counselor onboarding Continue button not working — added optional chaining to handle counselor records without email field"] },
  { version: "13.181-main", date: "2026-02-28", time: "8:56 PM", author: "Derek Richardson", changes: ["All: Multi-role login support — users with multiple roles (e.g., admin + counselor) now see a role picker after signing in instead of being locked to one dashboard", "Login: Google sign-in now checks all tables (admins, parents, counselors) and collects all matching roles", "Login: Email/password login now returns roles array from server for multi-role detection", "Admin: Nav bar shows 'Counselor View' button for users who also have the counselor role", "Counselor: Nav bar shows 'Admin View' button for users who also have the admin role", "Admin: Auth check accepts users with 'admin' anywhere in their roles array", "Counselor: Auth check accepts users with 'counselor' anywhere in their roles array", "Database: Added Audrey Richardson (audrey.k.richardson@gmail.com) and Derek Richardson (derek.richardson@gmail.com) as Google-login admin accounts", "Database: Added Audrey Richardson as counselor user and counselor profile (dual admin+counselor role)"] },
  { version: "13.181-dev", date: "2026-02-28", time: "8:50 PM", author: "Audrey Richardson", changes: ["All: Updated camp dates from 4 weeks to 2 weeks — camp now runs August 17-21 and August 24-28, 2026 only", "All: Removed July 13-17 and August 10-14 weeks from camp schedule", "Tests: Updated all test data and discount calculation tests to use new August dates", "PRD: Updated camp dates documentation to reflect 2-week schedule"] },
  { version: "13.180", date: "2026-02-23", time: "9:22 PM", author: "Derek Richardson", changes: ["All: Major code restructuring — extracted shared UI components (StableInput, VersionBanner, Toast, Modal, ImageCropper, PhotoUploadModal, ScrollableTabs) into src/shared/components/", "All: Extracted shared utilities (campDates, defaults, pricing) into src/shared/", "All: Extracted shared Netlify function boilerplate (CORS, schema, Supabase) into netlify/functions/utils/", "All: Total codebase reduced from 26,405 to 16,398 lines (38% reduction) by eliminating duplicated code and dead code", "Admin: Broke up 11,651-line admin/App.jsx into tab files (src/admin/tabs/) and component files (src/admin/components/) — admin shell now ~5,284 lines", "Counselor: Fixed references to deleted camp_registered_users table — now correctly uses camp_counselor_users", "Counselor: Removed dead code (CounselorOnboarding, FoodPhotosManager, SitePhotosManager, unused save functions and state) — reduced from 2,807 to 1,109 lines", "Parent: Removed dead code (FoodPhotosManager, SitePhotosManager, 12 unused save functions, 5 unused state variables) — reduced from 7,205 to 5,958 lines", "PRD: Added code restructuring to Performance features list", "CLAUDE.md: Updated FILE STRUCTURE section with full src/ directory layout and .cjs extensions"] },
