...
export const DEFAULT_CONTENT = {
  ...
  aboutText: "Join us for an incredible summer of basketball at Magnuson Community Center! Our camp is designed for young athletes who want to develop their basketball skills while having fun and making lasting friendships.",
  ...
  locationName: "Magnuson Community Center",
  locationAddress: "7110 62nd Ave NE",
  locationCity: "Seattle",
  locationState: "WA",
  locationZip: "98115",
  locationDetails: "Magnuson Community Center Gymnasium - Enter through the main entrance facing the parking lot. The gym is located on the first floor.",
  locationDirections: "From I-5: Take exit 171 for NE 65th St. Head east on NE 65th St, then turn left onto Sand Point Way NE. Turn right onto NE 74th St, then left onto 62nd Ave NE. The community center will be on your right. Free parking available in the lot.",
