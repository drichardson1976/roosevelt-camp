...
export default defineConfig({
  ...
  server: {
    headers: {
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://cdn.tailwindcss.com https://unpkg.com https://cdn.jsdelivr.net https://js.stripe.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://*.supabase.co https://api.resend.com https://accounts.google.com https://www.googleapis.com https://cdn.jsdelivr.net https://unpkg.com https://localhost:* ws://localhost:* https://api.stripe.com; frame-src https://accounts.google.com https://www.google.com https://js.stripe.com; frame-ancestors 'none';",
    },
  },
  build: {
    rollupOptions: {
